            ...
            <>
              ...
              <div className="points-summary">
                <div className="summary-header">
                  <div className="summary-col user-you">
                    <div className="user-avatar-small">
                      {data.currentUser.firstName[0]}{data.currentUser.lastName[0]}
                    </div>
                  ...
                  <div className="summary-col user-them">
                    <div className="user-avatar-small them">
                      {data.targetUser.firstName[0]}{data.targetUser.lastName[0]}
                    </div>
                ...
                <div className="period-rows">
                  <div className="period-row">
                    ...
                    <span className="period-label">Week {getDiffDisplay(data.comparison.pointsDiff.week)}</span>
                  ...
                  <div className="period-row">
                    ...
                    <span className="period-label">Month {getDiffDisplay(data.comparison.pointsDiff.month)}</span>
                  ...
                  <div className="period-row featured">
                    ...
                    <span className="period-label">Season {getDiffDisplay(data.comparison.pointsDiff.season)}</span>
                    ...
                    {data.comparison.sharedGolfers.map((p) => (
                      ...
                      >
                        <div className="chip-avatar">
                          {p.golfer.firstName[0]}{p.golfer.lastName[0]}
                        </div>
                        <div className="chip-info">
                          <span className="chip-name">{p.golfer.firstName} {p.golfer.lastName}</span>
              ...
              {!data.currentUser.hasTeam && (
                <div className="no-team-notice">
                  <p>You don't have a team yet. <Link to="/team-builder" onClick={onClose}>Build your team</Link> to compare!</p>
                </div>
              )}
