...
export const validators = {
  ...
  email:
    (message = 'Please enter a valid email address'): ValidatorFn =>
    (value: string) => {
  ...
  lettersOnly:
    (message = 'Only letters, spaces, hyphens, and apostrophes allowed'): ValidatorFn =>
    (value: string) => {
  ...
  alphanumeric:
    (message = 'Only letters, numbers, and underscores allowed'): ValidatorFn =>
    (value: string) => {
      if (!value.trim()) return null;
  ...
  url:
    (message = 'Please enter a valid URL'): ValidatorFn =>
    (value: string) => {
  ...
  positiveNumber:
    (message = 'Please enter a positive number'): ValidatorFn =>
    (value: string) => {
      if (!value.trim()) return null;
  ...
  nonNegativeInteger:
    (message = 'Please enter a non-negative whole number'): ValidatorFn =>
    (value: string) => {
      if (!value.trim()) return null;
  ...
  date:
    (message = 'Please enter a valid date'): ValidatorFn =>
    (value: string) => {
      if (!value.trim()) return null;
  ...
  passwordMatch:
    (getPassword: () => string, message = 'Passwords do not match'): ValidatorFn =>
    (value: string) => {
      return value === getPassword() ? null : message;
    },

  password:
    (message = 'Password must be at least 8 characters'): ValidatorFn =>
    (value: string) => {
  ...
  ukPhone:
    (message = 'Please enter a valid UK mobile number'): ValidatorFn =>
    (value: string) => {
      if (!value.trim()) return null;
